...
import com.example.learningcompose.ui.theme.PermissionHandlingComposeTheme
                        ...
                        when(perm.permission) {
                            Manifest.permission.CAMERA -> {
                                when {
                                    ...
                                    //status.shouldShowRationale is always false by default even when the application is installed for the first time or when app data is cleared.
